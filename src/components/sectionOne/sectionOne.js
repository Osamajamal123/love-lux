...
const Sectionone = () => {
  return (
    <div>
      <div className="backgroundImage pl-4 pr-4 w-full pt-12">
        <div className="backgroundwhite w-full lg:w-10/12 sectiontworounded shadow-md mt-10 pt-5 pl-4 pb-10">
          ...
          {/* //////////// */}
          {/* paragraph */}
          <div className="flex justify-start lg:justify-center w-full text-justify pt-11 pl-1">
